...
import { type StartedMatchState, StartedMatchStateIdl, Match } from "./Stadium";
...
export function subscribeWebsockets(
    backupSubscribe: () => void,
    callback: (msg: LiveStreamMessage) => void) {
    // TODO?
