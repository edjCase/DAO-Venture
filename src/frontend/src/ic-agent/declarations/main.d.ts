...
export interface DeterminateGatheringWorkPlan { 'weight' : number }
...
export interface EfficiencyGatheringWorkPlan { 'weight' : number }
...
export interface Work { 'workers' : bigint, 'units' : bigint }
