...
<div class="">
  ...
  <div class="my-5">
    ...
    {:else if "executing" in proposal.status}
      <div class="text-xl text-center text-green-600">Proposal Executing</div>
    {:else if "executed" in proposal.status}
      {#if proposal.status.executed.choice[0] === true}
        <div class="text-xl text-center text-green-600">Proposal Executed</div>
      {:else}
        <div class="text-xl text-center text-red-600">Proposal Rejected</div>
      {/if}
