...
module {
    let treantDamage = #random(1, 3);

    public let corruptedTreantScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "corrupted_treant";
        ...
        paths = [
            ...
            },
            {
                ...
                effects = [#damage(treantDamage)];
                paths = [{ weight = 1; condition = null; pathId = "victory" }];
            },
            {
                id = "purify_treant";
    ...
    let elfDamage = #random(1, 3);

    public let darkElfAmbushScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "dark_elf_ambush";
        ...
        paths = [
            ...
            },
            {
                ...
                effects = [];
                paths = [{ weight = 1; condition = null; pathId = "elf_attack" }];
            },
            {
    ...
    public let druidicSanctuaryScenarioMetaData : Scenario.ScenarioMetaData = {
    ...
    public let dwarvenWeaponsmithScenarioMetaData : Scenario.ScenarioMetaData = {
    ...
    public let enchantedGroveScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "enchanted_grove";
    ...
    public let fairyMarketScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "fairy_market";
        title = "Fairy Market";
    ...
    public let goblinRaidingPartyScenarioMetaData : Scenario.ScenarioMetaData = {
    ...
    public let knowledgeNexusScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "knowledge_nexus";
    ...
    public let lostElflingScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "lost_elfling";
        title = "Lost Elfling";
    ...
    public let mysteriousStructureScenarioMetaData : Scenario.ScenarioMetaData = {
    ...
    public let mysticForgeScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "mystic_forge";
        title = "Mystic Forge";
    ...
    public let sinkingBoatScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "sinking_boat";
        title = "Sinking Boat";
    ...
    public let trappedDruidScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "trapped_druid";
        title = "Trapped Druid";
    ...
    public let travellingBardScenarioMetaData : Scenario.ScenarioMetaData = {
        id = "travelling_bard";
    ...
    public let wanderingAlchemistScenarioMetaData : Scenario.ScenarioMetaData = {
